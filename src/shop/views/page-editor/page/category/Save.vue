					...
					<el-row :gutter="20">
					  ...
					  <el-col :span="12">
						  <el-form-item label="上级分类">
							<parentCascader class="fill-width" v-model="form.parentId" :curr="form.id" :clearable="true" placeholder="请选择页面分类"
...
<script>
	...
	export default {
		...
		methods: {
			...
			load(id){
				this.$request.load(microPageTypeApi.queryById({
					params:{
						id
					},
					before: () => {
			...
			save(){
				...
				var api = !this.form.id?microPageTypeApi.add:microPageTypeApi.edit
