			...
			<div class="dataview-content">
				<tableView ref="table" row-key="id" size="small" :search-form="searchForm" default-expand-all
					...
					<template slot="operate">
						<el-button size="small" type="primary" @click="addVisible=true">更新草稿箱</el-button>
					</template>
					...
					<el-table-column label="草稿ID" min-width="200" prop="code">
						<template slot-scope="scope">
							3081
						</template>
					</el-table-column>
					<el-table-column label="模版名称" min-width="200" prop="name">
						<template slot-scope="scope">
							盛世康养智慧平台
						</template>
					</el-table-column>
					<el-table-column label="来自APPID" min-width="200" prop="state">
						<template slot-scope="scope">
							wxa7a14e00e24149d0
						</template>
					</el-table-column>
					<el-table-column label="版本号" min-width="200" prop="validTime" >
						<template slot-scope="scope">
							20231122.1154
						</template>
					</el-table-column>
					<el-table-column show-overflow-tooltip label="上传者" min-width="200" prop="createTime">
						<template slot-scope="scope">
							yezs
						</template>
					</el-table-column>
					<el-table-column show-overflow-tooltip label="上传时间" min-width="200" prop="createTime">
						<template slot-scope="scope">
							2023-11-23 14:32:30
						</template>
					</el-table-column>
					<el-table-column width="120" align="center">
						<template slot-scope="scope">
							<el-button size="small" type="text" @click="edit(scope.row)">添至模板库</el-button>
						</template>
					</el-table-column>
				</tableView>
			</div>
